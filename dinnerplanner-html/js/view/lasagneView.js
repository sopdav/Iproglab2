	...
	this.update=function(){
		...
		this.dishPrep.html(this.dish.description);
			...
			for(var x = 0; x < this.dish.ingredients.length; x++){
				ingredientslist+= '<span style="padding:10px;">' + this.dish.ingredients[x].name + '</span><span style="padding:10px;">' + this.dish.ingredients[x].quantity + this.dish.ingredients[x].unit + '</span><span style="padding:10px;">' + 'SEK' + this.dish.ingredients[x].price + '</span><br>';
